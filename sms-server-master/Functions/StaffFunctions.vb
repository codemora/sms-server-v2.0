Module StaffFunctions
    ...
    Public Function addStaff(staff As Staff) As Boolean
        Try
            Return TA.Insert(staff.getRef, staff.getLastName, staff.getOtherNames, staff.getGender, staff.getDepartment, staff.getPosition, staff.getPassCode, staff.getPhone, staff.getSecondPhone, staff.getSecurityQuestion, staff.getSecurityAnswer, staff.getImage, staff.getIsActive, staff.getDeletedAt, staff.getCreatedAt, staff.getUpdatedAt)
    ...
    Public Function deleteStaff(staff As Staff) As Boolean
        Try
            Return TA.UpdateById(staff.getRef, staff.getLastName, staff.getOtherNames, staff.getGender, staff.getDepartment, staff.getPosition, staff.getPassCode, staff.getPhone, staff.getSecondPhone, staff.getSecurityQuestion, staff.getSecurityAnswer, staff.getImage, False, Today, staff.getCreatedAt, staff.getUpdatedAt, staff.getId)
        Catch ex As Exception
            MessageBox.Show(ex.Message)
            Return False
        End Try
    ...
    Public Function blockStaff(staff As Staff) As Boolean
        Try
            Return TA.UpdateById(staff.getRef, staff.getLastName, staff.getOtherNames, staff.getGender, staff.getDepartment, staff.getPosition, staff.getPassCode, staff.getPhone, staff.getSecondPhone, staff.getSecurityQuestion, staff.getSecurityAnswer, staff.getImage, Not staff.getIsActive, staff.getDeletedAt, staff.getCreatedAt, staff.getUpdatedAt, staff.getId)
        Catch ex As Exception
            MessageBox.Show(ex.Message)
            Return False
        End Try
    ...
    Public Function getStaffById(id As Integer) As Staff
        ...
        Dim second_phone As String = TA.GetDataById(id).Rows(0).Item("second_phone").ToString()
        ...
        Return New Staff(id, ref, last_name, other_names, gender, department, position, pass_code, phone, second_phone, security_question, security_answer, image, is_active, deleted_at, created_at, updated_at)
    End Function
    ...
    Public Function getStaffByRef(ref As String) As Staff
        ...
        Dim last_name As String = TA.GetDataByRef(ref).Rows(0).Item("last_name").ToString()
        Dim other_names As String = TA.GetDataByRef(ref).Rows(0).Item("other_names").ToString()
        Dim phone As String = TA.GetDataByRef(ref).Rows(0).Item("phone").ToString()
        Dim second_phone As String = TA.GetDataByRef(ref).Rows(0).Item("second_phone").ToString()
    ...
    Public Function getAllStaff() As List(Of Staff)
        ...
        For Each person In TA.GetData
            If person.Item("deleted_at") > Now Then
                ...
                Dim second_phone As String = person.Item("second_phone").ToString()
                ...
                staffList.Add(New Staff(id, ref, last_name, other_names, gender, department, position, pass_code, phone, second_phone, security_question, security_answer, image, is_active, deleted_at, created_at, updated_at))
            End If
        Next
        Return staffList
    End Function
    ...
    'Returns all Staff
    '
    Public Function getAllStaff(recsOnDisplay As Integer) As List(Of Staff)
        'create list of staffs
        Dim staffList As New List(Of Staff)
    ...
    'Returns all Staff
    '
    Public Function getAllStaff(page As Integer, numPerPage As Integer) As List(Of Staff)
        'create list of staffs
        Dim staffList As New List(Of Staff)
    ...
    Public Sub blockAllExpiredStaff()
        For Each person In TA.GetDataByDeleted
            ...
            Dim updated_at As DateTime = person.Item("updated_at")
            'adds staff object to stafflist
            updateStaff(New Staff(id, ref, last_name, other_names, gender, department, position, pass_code, phone, second_phone, security_question, security_answer, image, False, deleted_at, created_at, updated_at))
        Next
    End Sub
