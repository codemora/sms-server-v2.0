...
Partial Class Edit_Staff
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label7.Location = New System.Drawing.Point(317, 24)
        Me.Label7.Name = "Label7"
        Me.Label7.Size = New System.Drawing.Size(230, 32)
        Me.Label7.TabIndex = 24
        Me.Label7.Text = "EDIT STAFF DETAILS"
        '
        'btnUpdate
        '
        ...
        Me.btnUpdate.Location = New System.Drawing.Point(414, 428)
        ...
        Me.Panel1.Size = New System.Drawing.Size(805, 347)
        Me.Panel1.TabIndex = 25
        '
        'PictureBox1
        '
        Me.PictureBox1.Image = Global.sms_server_master.My.Resources.Resources.Profile_Image
        Me.PictureBox1.Location = New System.Drawing.Point(647, 63)
        ...
        Me.btnRemove.Location = New System.Drawing.Point(713, 200)
        ...
        Me.btnUpload.Location = New System.Drawing.Point(647, 200)
        ...
        Me.cmbDepartment.Items.AddRange(New Object() {"----------Select Department----------", "3CGS", "Academics And Students Affairs", "Basic And Applied Biology", "Business Development Unit", "Cafetaria", "Chemical Sciences", "Civil And Environmental Engineering", "Computer And Electrical Engineering", "Computer Science And Informatics", "Ecotourism, Recreation And Hospitality", "Energy And Petroleum Engineering", "Entrepreneurship And Business Sciences", "Environmental Management", "EORIC", "Estate", "Examinations Office", "Finance Directorate", "Fisheries And Water Resources", "Forest Science", "General Administration  Division/Transport", "Graduate Studies", "Guidance And Couselling", "Horticulture And Crops/Animal Production", "Human Resources", "IT Directorate", "Internal Audit", "Languages And General Studies", "Legal", "Library", "Mathematics And Statistics", "Mechanical And Manufacturing Engineering", "Office Of The Dean Of Students", "Office Of The Pro Vice-Chancellor", "Office Of The Registrar", "Office Of The Vice-Chancellor", "Procurement", "Quality Assurance And Planning", "RCEES", "School Of Agriculture", "School Of Engineering", "School Of Management Sciences And Law", "School Of Natural Resources", "School Of Sciences", "Security Services", "Sports", "Uenr Basic School", "University Clinic", "University Relations Office", "Works And Physical Development", "Others"})
        ...
        Me.cmbPosition.Items.AddRange(New Object() {"----------Select Position----------", "Accountant", "Accounting Assistant", "Accounts Clerk Gd I", "Acting Registrar", "Administrative Assistant", "Architect", "Artisan", "Assistant Acountant", "Assistant Counsellor", "Assistant Estate Officer", "Assistant Lecturer", "Assistant Librarian", "Assistant Registrar", "Assistant Registrar (Faculty Officer)", "Assistant Research Fellow", "Assistant Security Officer", "Assistant Transport Officer", "Associate Professor", "Attendant", "Auditing Assistant", "Casual Labourer", "Casual Staff", "Chief Driver", "Chief Works Superintendent", "Clerk of Works", "Conservancy Labourer", "Cook", "Deputy Director of Finance", "Director of Finance", "Director of Works", "Dispensing Technician", "Domestic Bursar", "Draughtsman", "Driver Grade I", "Driver Grade II", "Electrical Technician", "Farm Overseer II", "Foreman", "Hall Assistant", "Head Conservancy Labourer", "Head of Guid. & Counselling Unit", "Headmistress", "Intern", "Internal Auditor", "Junior Assistant Librarian", "Junior Assistant Registrar", "Junior Assistant Registrar (Faculty Officer)", "Junior Hall Assistant", "Lab. Technician", "Labourer", "Lecturer", "Library Assistant", "National Service Person", "Plumber", "Principal Accounting Assistant", "Principal Administrative Assistant", "Principal Assistant Curator", "Principal Estate Assistant", "Principal ICT Assistant", "Principal Technician", "Pro Vice-Chancellor", "Procurement Officer", "Professor", "Programmer Analyst", "Quantity Surveyor", "Registrar ", "Sanitary/Health Labourer", "Security Guard Grade I", "Security Guard Grade II", "Security Officer", "Senior Accountant", "Senior Accounting Assistant", "Senior Accounts Clerk", "Senior Administrative Assistant", "Senior Architect", "Senior Assistant Registrar", "Senior Auditing Assistant", "Senior Campus Guard", "Senior Class Assistant", "Senior Coach", "Senior Conservancy Labourer", "Senior Domestic Bursar", "Senior Driver", "Senior Estate Assistant", "Senior Hall Assistant", "Senior Headman", "Senior Health Superintendent", "Senior ICT Assistant", "Senior Internal Auditor", "Senior Laboratory Technician", "Senior Lecturer", "Senior Library Assistant", "Senior Medical Officer", "Senior Procurement Assistant", "Senior Procurement Officer", "Senior Project/Technical Officer", "Senior Quantity Surv. Assistant", "Senior Research Assistant", "Senior Sanitary Headman", "Senior Security Officer", "Senior Sports Coach", "Senior Stores Superintendent", "Senior Teacher", "Senior Teaching Assistant", "Senior Technician", "Senior Technician Assistant", "Senior Works Superintendent", "Structural Engineer", "Teacher", "Technical Instructor", "Technician", "Technician II", "Tradesman Grade I", "Tradesman Grade II (Carpenter)", "Tradesman Grade II (Mason)", "Tradesman Grade II (Plumber)", "Tradesman II", "Tradesman II (Electrician)", "Vice–Chancellor", "Works Superintendent", "Others"})
