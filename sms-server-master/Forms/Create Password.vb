Public Class Create_Password
    Dim user As User = getUserByUsername(My.Settings.DISPLAY_NAME)
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Dim new_user As New User(user.getId, user.getLastName, user.getOtherNames, user.getPrivilege, user.getUsername, txtPassword.Text, user.getPhone, cmbSecurityQuestion.Text, txtSecurityAnswer.Text, user.getImage, user.getIsActive, user.getDeletedAt, user.getCreatedAt, user.getUpdatedAt)
